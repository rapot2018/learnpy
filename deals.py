...
DEAL_SOURCES = [
    ...
    {
        "name": "Gaming Deals",
        "url": GN + "gaming+deals+ps5+xbox+nintendo+discount+2026",
        "icon": "🎮",
        "color": "#7c3aed",
        "description": "Console, PC & game discounts",
    },
    {
        "name": "Software Deals",
        "url": GN + "software+app+saas+lifetime+deal+discount",
        "icon": "💿",
        "color": "#0891b2",
        "description": "App, SaaS & software discounts",
    },
    {
        "name": "Student Deals",
        "url": GN + "student+discount+deals+education+2026",
        "icon": "🎓",
        "color": "#16a34a",
    ...
    },
    {
        ...
        "url": GN + "clearance+sale+liquidation+blowout+deal",
        "icon": "🏷️",
        "color": "#dc2626",
        "description": "Clearance & liquidation bargains",
    },
    {
        "name": "Pet Deals",
        "url": GN + "pet+supplies+dog+cat+deals+sale+discount",
        "icon": "🐾",
        "color": "#d97706",
        "description": "Deals on pet food, toys & supplies",
    },
    {
        "name": "Kids & Baby",
        "url": GN + "baby+kids+toys+deals+sale+discount",
        "icon": "🧸",
        "color": "#ec4899",
        "description": "Toys, baby gear & kids' essentials",
    },
    {
        "name": "Sports & Outdoors",
        "url": GN + "sports+outdoor+fitness+equipment+deals+sale",
        "icon": "⛺",
        "color": "#15803d",
        "description": "Gear for sports, camping & outdoors",
    },
    {
        "name": "Streaming Deals",
        "url": GN + "streaming+subscription+deal+discount+2026",
        "icon": "📺",
        "color": "#e11d48",
        "description": "Streaming & entertainment discounts",
    },
    {
        "name": "Grocery Deals",
        "url": GN + "grocery+supermarket+food+deals+coupon+2026",
        "icon": "🛒",
        "color": "#059669",
        "description": "Supermarket savings & food coupons",
    },
    {
        "name": "Luxury Deals",
        "url": GN + "luxury+designer+premium+deals+sale+discount",
        "icon": "💎",
        "color": "#92400e",
        "description": "Premium & luxury brand discounts",
    },
]
...
CATEGORY_KEYWORDS = {
    "tech": ["laptop", "phone", "tablet", "headphone", "camera", "tv", "monitor", "keyboard", "mouse", "gaming",
             ...
             "xbox", "nintendo", "earbuds", "smartwatch", "router", "ssd", "ram", "software", "app", "saas"],
    "fashion": ["shirt", "pants", "dress", "shoes", "sneakers", "jacket", "coat", "clothing", "apparel", "jeans",
                ...
                "designer", "luxury", "handbag", "sunglasses"],
    "travel": ["flight", "hotel", "vacation", "travel", "trip", "cruise", "airbnb", "booking", "resort", "airline",
               "rental car", "passport", "expedia"],
    "food": ["food", "restaurant", "pizza", "burger", "meal", "grocery", "doordash", "uber eats", "coffee",
             "starbucks", "chipotle", "delivery", "dining", "snack", "drink", "supermarket", "instacart"],
    "home": ["furniture", "sofa", "bed", "kitchen", "appliance", "vacuum", "mattress", "home", "decor", "tools",
             "lamp", "chair", "table", "cleaning", "storage", "cookware", "blender", "garden", "lawn mower"],
    "health": ["fitness", "gym", "supplement", "vitamin", "health", "wellness", "yoga", "protein", "workout",
               "exercise", "running", "whey", "creatine", "treadmill", "weights", "sports", "outdoor", "camping"],
    "beauty": ["makeup", "skincare", "beauty", "hair", "cosmetic", "lotion", "perfume", "serum", "moisturizer",
               "shampoo", "conditioner", "spa", "salon"],
    "gaming": ["ps5", "xbox", "nintendo", "switch", "playstation", "gaming", "game", "console", "steam",
               "controller", "gpu", "graphics card"],
    "kids": ["baby", "kids", "toddler", "toy", "children", "stroller", "diaper", "infant", "nursery", "lego"],
    "pets": ["dog", "cat", "pet", "puppy", "kitten", "fish", "bird", "hamster", "paw", "animal", "vet"],
    "streaming": ["netflix", "disney", "hulu", "hbo", "spotify", "apple tv", "amazon prime", "streaming",
                  "subscription", "paramount"],
    "student": ["student", "education", "college", "university", "textbook", "course", "online learning", "udemy"],
}
